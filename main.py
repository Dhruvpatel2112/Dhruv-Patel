...
URL = "rtsp://admin:Admin@123@192.168.1.101:554/Streaming/Channels/102"
...
def camera_recog():
    ...
    while True:
        ...
        if len(aligns) > 0:
            thread = Thread(target=recognizeProcess, args=(
...
def create_data_images(new_name):
